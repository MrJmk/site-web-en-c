...
printf("                    <li role=\"presentation\"><a href=\"http://localhost/Partenariat/untitled-1.html\">Statistiques<span class=\"caret\"></span></a></li>\n");
...
printf("            <h1><strong><em>Administrateur</em></strong> </h1>\n");
printf("            <p>.</p>\n");
printf("            <p></p>\n");
printf("        </div>\n");
printf("    </div>\n");
printf("    <div>\n");
printf("        <div class=\"btn-group\" role=\"group\" id=\"modif\">\n");
printf("            <button class=\"btn btn-success btn-lg\" type=\"button\" data-toggle=\"modal\" href=\"#ajout\">AJOUTER <i class=\"glyphicon glyphicon-plus-sign\"></i></button>\n");
printf("            <button class=\"btn btn-warning btn-lg\" type=\"button\" data-toggle=\"modal\" href=\"#modification\">MODIFIER<i class=\"glyphicon glyphicon-pencil\"></i></button>\n");
printf("            <button class=\"btn btn-danger btn-lg\" type=\"submit\" data-toggle=\"modal\" href=\"#suppression\">SUPPRIMER <i class=\"glyphicon glyphicon-trash\"></i></button>\n");
printf("        </div>\n");
printf("    </div>\n");
